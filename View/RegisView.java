...
/**
 * Cette classe permet l'affichage du formulaire d'inscription
 * @author Hymed
 **/
public class RegisView extends JFrame {
	...
	private JTextField txtPseudo = new JTextField(15);
	private JTextField txtNom = new JTextField(15);
	private JTextField txtPrenom = new JTextField(15);
	private JTextField txtMotDePasse = new JPasswordField(15);
	private JTextField txtMotDePasse2 = new JPasswordField(15);
	private JSeparator separator = new JSeparator();
	private JLabel lblIntro = new JLabel(
			"Inscris-toi, joue et bats les records pour t'\u00E9lever en haut du classement");
...
/**
 * Cette méthode initialise l'interface graphique contenant le formulaire d'inscription
 */
	...
	public JLabel getLblConfirmerLeMot() {
		return lblConfirmerLeMot;
	}
